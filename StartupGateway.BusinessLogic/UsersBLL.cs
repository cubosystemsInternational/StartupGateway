...
namespace StartupGateway.BusinessLogic
{
    ...
    public class UsersBLL
    {
        ...
        /// </summary>
        public UsersBLL(IUnitOfWork unitOfWork, ILogger<UsersBLL> logger)
        {
        ...
        public Users GetUserById(int userId)
        {
            try
            {
                using var userRepository = _unitOfWork.GetDAL<IUsersDAL>();
        ...
        public List<Users> GetAllUsers()
        {
            try
            {
                ...
                using var userRepository = _unitOfWork.GetDAL<IUsersDAL>();
                return (List<Users>)userRepository.GetAllRecords();
            }
            catch (Exception ex)
            {
        ...
        public object UpdateUser(Users updatedUser)
        {
            try
            {
                using var userRepository = _unitOfWork.GetDAL<IUsersDAL>();
